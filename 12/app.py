...
def _load_wiz_issues() -> tuple[list[dict[str, Any]], list[str]]:
    """Load one or more Developer Console GraphQL exports from wiz_data.

    Any JSON file containing an issuesV2.nodes array is accepted. Files are
    merged and deduplicated by issue id, allowing users to save paginated
    Developer Console responses as issues_page_001.json, issues_page_002.json,
    etc. A single issues.json works too.
    """
